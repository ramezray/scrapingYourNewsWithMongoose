...
$(document).on("click", "p", function () {
    ...
    $.ajax({
        ...
        .then(function (data) {
            ...
            $("#notes").append("<input id='titleinput' placeholder =Add_Title_to_Your_Note name='title' >");
            // A textarea to add a new note body
            $("#notes").append("<textarea placeholder =Add_Your_Note_Here id='bodyinput' name='body'></textarea>");
